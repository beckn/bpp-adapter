          ...
          responses: [
            {
              ...
              message: {
                order: {
                  ...
                  descriptor: {
                    name: res?.attributes?.provider_id?.data?.attributes?.provider_name,
                  },
                  fulfillments: [
                    {
                      id: "",
                  ...
                  locations: [
                    {
                      id: res?.attributes?.provider_id?.data?.attributes?.location_id?.data?.id,
                      city: {
                        name: res?.attributes?.provider_id?.data?.attributes?.location_id?.data?.attributes?.city,
                      },
                    },
                  ],
                  ...
                  items: [
                    {
                      ...
                      descriptor: {
                        ...
                        images: [
                          {
                            url: res?.attributes?.provider_id?.data?.attributes?.logo?.data?.attributes?.url,
                          },
                        ],
                      },
                      price: {
                        currency:
                          res?.attributes?.sc_retail_product?.data?.attributes?.currency?res?.attributes?.sc_retail_product?.data?.attributes?.currency:"INR",
                        value:
                          res?.attributes?.sc_retail_product?.data?.attributes?.min_price?res?.attributes?.sc_retail_product?.data?.attributes?.min_price.toString():"0",
                      },
                      ...
                      rating:
                        res?.attributes?.sc_retail_product?.data?.attributes?.rating?res?.attributes?.sc_retail_product?.data?.attributes?.rating:"0",
                      rateable: true,
